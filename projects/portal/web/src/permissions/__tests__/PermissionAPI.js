...
describe('PermissionAPI', () => {
    it('fetches permissions with proper URL and headers', () => {
        ...
        expect(mockAxios.get).toHaveBeenCalledWith('http://localhost:8081/api/v1/permissions/?all=true&iri=resource-iri',
            {
                headers: {
    ...
    it('calls permissions modification with proper URL, payload and headers', () => {
        ...
        expect(mockAxios.put).toHaveBeenCalledWith('http://localhost:8081/api/v1/permissions/?iri=resource-iri',
